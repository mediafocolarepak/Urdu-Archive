import { sb, State, esc, labelOf, optionsHtml, canWrite, isAdmin, withStatus, DASH_ROW_LIMIT, DASH_SORTABLE, likeSafe } from './core.js?v=20260901220646';
import { renderDocDetail, createNewDocument } from './docdetail.js?v=20260901220646';
